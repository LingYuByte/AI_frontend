<template>
    ...
    <n-carousel show-arrow autoplay style="width: 100%; height: 240px; border-radius: 8px">
        <div class="carousel-slide" :class="{ 'dark-mode-overlay': isDarkTheme }">
            <img class="carousel-img" src="https://www.LingYu Byte AI.cn/image/1.png" />
        ...
        <div class="carousel-slide" :class="{ 'dark-mode-overlay': isDarkTheme }">
            <img class="carousel-img" src="https://www.LingYu Byte AI.cn/image/2.png" />
            <div class="carousel-caption">
                <img class="carousel-favicon" src="https://LingYu Byte AI.cn/favicon.ico" />
                <h3>LingYu Byte AI_WinUi启动器</h3>
                <p>来自LingYu Byte AI官方开发组，简洁美观，专为Win10以上设计</p>
            </div>
        </div>
