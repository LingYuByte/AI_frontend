    ...
    <NCard title="AI 图片编辑">
        ...
        <NFlex align="center" justify="center" vertical style="margin-top: 5px;">
            <NFlex vertical align="center" justify="center">
                <NSelect v-model:value="size" :options="[{label: '256x256', value: '256x256'}, {label: '512x512', value: '512x512'}, {label: '1024x1024', value: '1024x1024'}]"></NSelect>
                <NInput v-model:value="prompt"></NInput>
            </NFlex>
        ...
        <ImageEditor :route-able="false" :resizAble="false" :export-func="makeEdit"></ImageEditor>
    </NCard>
</template>
