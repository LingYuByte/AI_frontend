...
./frpc.exe -u LingYu Byte AITokenPreview -p 114514
`
...
server_port = 7000
tls_enable = false
user = LingYu Byte AITokenPreview
token = LingYu Byte AIToken
